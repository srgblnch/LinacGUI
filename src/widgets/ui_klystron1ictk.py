...
class Ui_klystron1itck(object):
    def setupUi(self, klystron1itck):
        ...
        self.sf6p1Led = LinacLed(self.ictkGroup)
        ...
        self.rfw1Led = LinacLed(self.ictkGroup)
        ...
        self.rfw2Led = LinacLed(self.ictkGroup)
        ...
        self.rfl1Led = LinacLed(self.ictkGroup)
        ...
        self.rfl2Led = LinacLed(self.ictkGroup)
