...
#
# Created: Wed Mar 12 13:15:21 2014
...
class Ui_linacConfigurationScreen(object):
    def setupUi(self, linacConfigurationScreen):
        ...
        linacConfigurationScreen.setMinimumSize(QtCore.QSize(1250, 825))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1221, 826))
        ...
        self.gridLayout_2.addWidget(self.timingSnapshot, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radioFrequencySnapshot, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.vacuumValveSnapshot, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.klystronSnapshot, 4, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.magnetSnapshot, 0, 2, 5, 2)
