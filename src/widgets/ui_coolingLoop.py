...
class Ui_CoolingLoop(object):
    def setupUi(self, CoolingLoop):
        ...
        self.gridLayout_2.addWidget(self.powerLabel, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.epsPressureValue, 3, 1, 1, 1)
        ...
        self.horizontalLayout.addWidget(self.coolingLoopStatus)
        self.coolingLoopStatusHistory = QtGui.QToolButton(self.coolingLoopGroup)
        self.coolingLoopStatusHistory.setObjectName(_fromUtf8("coolingLoopStatusHistory"))
        self.horizontalLayout.addWidget(self.coolingLoopStatusHistory)
    ...
    def retranslateUi(self, CoolingLoop):
        ...
        self.coolingLoopStatusHistory.setText(QtGui.QApplication.translate("CoolingLoop", "...", None, QtGui.QApplication.UnicodeUTF8))
