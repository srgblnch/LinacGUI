...
class Ui_klystronLV(object):
    def setupUi(self, klystronLV):
        ...
        self.verticalLayout.addWidget(self.LV_TimeLabel)
        ...
        self.verticalLayout.addWidget(self.LV_TimeValue)
        ...
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.taurusGroupBox_2)
        ...
        self.verticalLayout_2.addWidget(self.heatStatus)
        ...
        self.verticalLayout_2.addWidget(self.heatTLabel)
        ...
        self.verticalLayout_2.addWidget(self.heatTValue)
